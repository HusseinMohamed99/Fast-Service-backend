...
class WorkerInformationRequest extends Request
{
    ...
    public function rules(): array
    {
        return [
            ...
            'price_from' => ['nullable', 'exclude_if:address,present,details,present,price_to,present,working_hours_from,present,working_hours_to,present'],
            'price_to' => ['nullable', 'exclude_if:address,present,details,present,price_from,present,working_hours_from,present,working_hours_to,present'],
